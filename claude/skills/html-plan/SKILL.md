...
2. **Mimo projekt / jednorázová diskuse:** scratchpad adresář session.
...
Tento skill nenahrazuje plan mode. Pokud je aktivní plan mode, plán pro schválení předlož normálně přes ExitPlanMode — HTML soubor vytvoř jako doprovodný, čitelnější artefakt téhož plánu.
